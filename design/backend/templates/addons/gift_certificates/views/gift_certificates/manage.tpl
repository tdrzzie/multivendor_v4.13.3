                ...
                <tbody>
                    {foreach $gift_certificates as $gift}
                        ...
                        >
                            ...
                            <td width="15%" data-th="{__("date")}" class="row-status"><a href="{"gift_certificates.update?gift_cert_id=`$gift.gift_cert_id`"|fn_url}" class="underlined">{$gift.timestamp|date_format:"`$settings.Appearance.date_format`, `$settings.Appearance.time_format`"}</a></td>
