            ...
            {if $auth.user_id}
                ...
                {if !"ULTIMATE:FREE"|fn_allowed_for}
                    {if $menu_languages|sizeof > 1}
                        {include file="common/select_object.tpl" style="dropdown" link_tpl=$config.current_url|fn_link_attach:"sl=" items=$menu_languages selected_id=$smarty.const.CART_LANGUAGE display_icons=true key_name="name" key_selected="lang_code" class="languages"}
                    {/if}
                {/if}
                <!--end language-->
    ...
    <div class="subnav" id="header_subnav">
        ...
        <ul class="nav hover-show nav-pills">
            ...
            <ul class="nav hover-show nav-pills nav-child mobile-visible">
                <!--language-->
                {if $menu_languages|sizeof > 1}
                    {include file="common/select_object.tpl" style="dropdown" link_tpl=$config.current_url|fn_link_attach:"sl=" items=$menu_languages selected_id=$smarty.const.CART_LANGUAGE display_icons=true key_name="name" key_selected="lang_code" class="languages" plain_name=__("language")}
                {/if}
                <!--end language-->
