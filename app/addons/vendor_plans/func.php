...
function fn_calculate_commission_for_payout(array $order_info, array $company_data, array $payout_data)
{
    if (
        ...
        if (!YesNo::toBool(Registry::get('addons.vendor_plans.include_taxes_in_commission'))) {
        ...
        if (!$is_refund) {
            ...
            $commission_amount = $percent_commission - $fixed_commission - $surcharge_to_commission;
        }
