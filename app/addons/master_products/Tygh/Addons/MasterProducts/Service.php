...
class Service
{
    ...
    public function actualizeMasterProductPrice($product_id)
    {
        ...
        $vendor_product_ids = $this->product_repository->findVendorProductIds($master_product_id, ['A'], ['A'], $this->is_show_out_of_stock_products_enabled);
        ...
        foreach ($vendor_product_ids as $vendor_product_id) {
            $vendor_product_data = [];
            fn_get_product_prices($vendor_product_id, $vendor_product_data, [], 0, true);
